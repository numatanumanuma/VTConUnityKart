...
public static class TransformExtensions
{
    ...
    public static TransformStampedMsg ToROSTransformStamped(this Transform tfUnity, double timeStamp)
    {
        return new TransformStampedMsg(
            // new HeaderMsg(new TimeStamp(timeStamp), tfUnity.parent.gameObject.name), // ROS2
            new HeaderMsg(ROSTransformTreePublisher.seq, new TimeStamp(timeStamp), tfUnity.parent.gameObject.name), // ROS1
